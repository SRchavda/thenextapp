...
const dummyCustomers: Customer[] = [
  ...
  { id: 2, name: 'Jane Smith', email: 'jane.smith@example.com', phone: '987-654-3210', address: '456 Oak Ave' },
  { id: 3, name: 'Alice Johnson', email: 'alice.johnson@example.com', phone: '555-123-4567', address: '789 Pine Ln' },
];
      ...
      {selectedCustomer && (
        <div className="fixed top-0 left-0 w-full h-full bg-gray-500 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-md">
            <h3 className="text-lg font-bold mb-4">Past Orders for {selectedCustomer.name}</h3>
